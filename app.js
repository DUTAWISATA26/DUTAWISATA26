        ...
        return `
            <div class="creator-card ${isActive}" data-id="${creator.id}" style="--card-accent-rgb: ${creator.accentRgb}">
                ...
                <div class="card-footer">
                    <span style="font-size: 0.85rem; font-weight: 800; color: rgb(var(--card-accent-rgb, var(--accent-rgb)));">Info Selengkapnya</span>
...
function selectCreator(creatorId) {
    ...
    // Reset scroll position of the details card
    creatorDetailCard.scrollTop = 0;

    // Smooth scroll to detail section if on desktop/stacked layout
    ...
    creatorDetailCard.innerHTML = `
        ...
        <div class="detail-footer">
            <div class="calculator-summary">
                ...
                <div class="calc-total" id="calc-total" style="font-size: 1.1rem;"></div>
            </div>
